<%-- /*------------------------------------------------------------------------------ * PROJ : LG Group Recruit Portal
  Prj. * NAME : registAppBaseInfo.jsp * DESC : 입사지원서 작성 - 기본인적사항/상세인적사항/경력사항/자기소개서/제출확인 * Author : Publisher * Copyright
  2013 LG Group, All rights reserved. *------------------------------------------------------------------------------ *
  Change Logs *------------------------------------------------------------------------------ * 1.0. YoungRan : 2013. 9.
  30. Initial Created. 현장직추가 2018.05.08 * 1.1. wssim : 2019. 8. 22. 동의서 추가 ((agree190822))_
  *------------------------------------------------------------------------------*/ --%>
    ...
    <body>
      <%@ include file="/WEB-INF/jsp/com/include/skipnavigation.jspf" %>
                ...
                <div class="LblockContentMain">
                  <c:if test="${jobNoticeInfo.recruitTypeCode != 'D' && jobNoticeInfo.recruitTypeCode != 'H'}">
                    <div class="LblockTab indicate">
                      <ul>
                        <li class="Lfirst Lcurrent"><a href="#LblockTabContent01" onclick="$.submitFlag();">
                        ...
                        <li class="Llast"><a href="#LblockTabContent05" onclick="$.fViewAppCompleteDoc();">
                            <c:choose>
                              <c:when
                                test="${jobNoticeInfo.careerTypeCode == 'A' || jobNoticeInfo.careerTypeCode == 'C'}">
                  ...
                  <div id="LblockTabContent01" class="LblockTabContent">
                    <form id="baseInfoForm" name="baseInfoForm" method="post" enctype="multipart/form-data">
                      <c:if test="${jobNoticeInfo.recruitTypeCode != 'D' && jobNoticeInfo.recruitTypeCode != 'H'}">
                        <h2 class="Lhide">
                          <LTag:message code="app.tab.baseInfo" />
                        </h2>
                        ...
                        <div class="foldedInphone">
                          ...
                          <div class="ddFoldedInPhone">
                            <div class="LblockDetailTable">
                              <input type="hidden" id="orderOfDesireCount" name="orderOfDesireCount"
                                value="<c:out value='${orderOfDesireCount}' />" />
                              <table id="desireTable" class="applicationform desire rsp rsp-hori rsp-tablet">
                                <caption>지원사항</caption>
                                <tbody>
                                  <tr<c:if test="${jobNoticeInfo.subCompanyYn eq 'Y'}">
                                    style="display:none;"
                      </c:if>>
                      <th scope="row" style="width:20%;"><label class="required"><span class="Lhide">(필수)</span>
                      ...
                      <c:forEach items="${orderOfDesireList.code}" varStatus="i">
                        <tr>
                          <th scope="row" style="width:20%;"><label <c:if
                              ...
                              <c:if test="${orderOfDesireList.code[i.index] == '1'}"><span class="Lhide">(필수)</span>
                              </c:if>
                              <c:out value='${orderOfDesireList.value[i.index]}' />
                            </label></th>
                          <td class="twoOrMoreSelects">
                            <select id="orgCode_${orderOfDesireList.code[i.index]}"
                              name="orgCode_${orderOfDesireList.code[i.index]}" onchange="onChangeOrgCode(this);"
                            ...
                            <c:forEach items="${desireOrgCodeList.orgCode}" varStatus="j">
                              <option value="<c:out value='${desireOrgCodeList.orgCode[j.index]}'/>" <c:if
                            ...
                            <input type="hidden" id="recSectorId_${orderOfDesireList.code[i.index]}"
                            ...
                            <select id="jobCode_${orderOfDesireList.code[i.index]}"
                              name="jobCode_${orderOfDesireList.code[i.index]}" onchange="onChangeJobCode(this);"
                              title="<c:out value='${orderOfDesireList.value[i.index]}' /> <LTag:message code="
                              app.lbl.jobCode" />">
                            <option value="">
                            ...
                            <c:forEach items="${desireJobCodeList.jobCode}" varStatus="k">
                              <c:if
                                ...
                                <c:if test="${hopeWork.recSectorId[i.index]==desireJobCodeList.recSectorId[k.index]}">
                                  <input type="hidden" id="input_jobCode_${orderOfDesireList.code[i.index]}"
                            ...
                            <c:forEach items="${desireLocCodeList.locationCode}" varStatus="l">
                              <c:if
                                ...
                                <input type="hidden" id="input_locationCode_${orderOfDesireList.code[i.index]}"
                      ...
                      <%-- <c:if test="${jobNoticeInfo.lgatFlag == 'Y'}">
                        <tr>
                          <th class="crapInPhone" scope="row"><label class="required" for="fitLocCode"><span
                                class="Lhide">(필수)</span>
                          ...
                          <td class="twoOrMoreSelects">
                            <select id="fitLocCode" name="fitLocCode">
                              ...
                              <c:choose>
                                <c:when test="${not empty baseInfo.fitLocCode}">
                                  ...
                                  <c:forEach items="${lgatAreaList.code}" varStatus="l">
                                    <option value="<c:out value='${lgatAreaList.code[l.index]}'/>" <c:if
                                      test="${baseInfo.fitLocCode==lgatAreaList.code[l.index]}">
                                      selected="selected" </c:if>>
                                      <c:out value='${lgatAreaList.value[l.index]}' />
                                    </option>
                                  </c:forEach>
                                </c:when>
                                <c:when
                                ...
                                <c:otherwise>
                                  ...
                                  <c:forEach items="${lgatAreaList.code}" varStatus="l">
                                    <option value="<c:out value='${lgatAreaList.code[l.index]}'/>">
                                      <c:out value='${lgatAreaList.value[l.index]}' />
                                    </option>
                                  </c:forEach>
                                </c:otherwise>
                            ...
                            <select id="fitLangCode" name="fitLangCode">
                              ...
                              <c:forEach items="${lgatLangList.code}" varStatus="l">
                                <option value="<c:out value='${lgatLangList.code[l.index]}'/>" <c:if
                            ...
                            <c:if test="${jobNoticeInfo.careerTypeCode == 'A' && jobNoticeInfo.recruitTypeCode == 'A'}">
                              ...
                              <div class="LinstructionWithinTable sameOpenRecruitApplicationList">
                                <c:forEach items="${sameOpenRecruitApplicationList.jobNoticeName}" varStatus="l">
                                  <div>
                                    <span>[
                                      <c:out value='${sameOpenRecruitApplicationList.companyName[l.index]}' />
                                      /
                                      <c:out value='${sameOpenRecruitApplicationList.resumeStatusName[l.index]}' />
                                      ]
                                    </span>
                                    <span>
                                      <c:out value='${sameOpenRecruitApplicationList.jobNoticeName[l.index]}' />
                                    </span>
                                    <strong>[
                                      <c:out value='${sameOpenRecruitApplicationList.fitLocName[l.index]}' />
                                      ]
                                    </strong>
                                  </div>
                                </c:forEach>
                    ...
                    <table class="applicationform rsp rsp-hori rsp-tablet">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><input type="radio" id="fGenderM" name="genderCode" value="M" <c:if
                              test="${baseInfo.genderCode == 'M'}">
                            checked="checked" </c:if> /><label for="fGenderM">
                              <LTag:message code="app.lbl.male" />
                            </label>
                            <input type="radio" id="fGenderF" name="genderCode" value="F" <c:if
                              test="${baseInfo.genderCode == 'F'}">
                            checked="checked" </c:if> /><label for="fGenderF" id="gender_female">
                        ...
                        <tr>
                          <th scope="row" style="width:20%;"><label class="required" for="nationalityName"><span
                                class="Lhide">(필수)</span>
                              <LTag:message code="app.lbl.nationalityCode" />
                            </label></th>
                          <td>
                            <div class="input_search">
                              <input type="text" id="nationalityName" name="nationalityName" size="10"
                                value="${!empty baseInfo.nationalityName == true ? baseInfo.nationalityName : '대한민국(한국)'}"
                                readonly="readonly" />
                              <input type="hidden" id="nationalityCode" name="nationalityCode"
                          ...
                          <td colspan="3">
                            <select id="visaTypeCode" name="visaTypeCode">
                              ...
                              <c:forEach items="${visaTypeList.code}" varStatus="l">
                                <option value="<c:out value='${visaTypeList.code[l.index]}'/>" <c:if
                        ...
                        <tr>
                          ...
                          <th scope="row" style="width:20%;"><label class="required" for="additionalContact"><span
                                class="Lhide">(필수)</span>
                          ...
                          <td>
                            ...
                            <input id="additionalContact" name="additionalContact" type="text" size="20"
                              value="<c:out value='${applyMasterInfo.additionalContact}'/>"
                              onKeyPress="return $.onKeyPressFilter('[0-9-]', event);" style="ime-mode:disabled;"
                              onkeyup="this.value=this.value.replace(/[^0-9-]/g,'')" maxlength="30" />
                          </td>
                        </tr>
                        <c:choose>
                          <c:when
                            ...
                            <tr>
                              <th scope="row" style="width:20%;"><label class="required" for="addFile"><span
                                    class="Lhide">(필수)</span>
                              ...
                              <td colspan="3">
                                <div class="set_selectInput hiddenInPhone hiddenInTablet">
                                  ...
                                  <input type="hidden" id="baseattachFileId" name="baseattachFileId"
                                  ...
                                  <ul id="baseThesis" class="LblockItemList Lfile">
                                    <c:forEach items="${baseApplyFileList.attachFileId}" varStatus="j">
                                      <li style="">
                                        <p><a href="javascript:;"
                                          ...
                                          </a><button type='button' onclick='deleteItem(this);'>삭제</button>
                                        </p>
                          ...
                          <c:otherwise>
                            <c:if test="${jobNoticeInfo.addressFlag == 'N'}">
                              <tr>
                                <th scope="row" style="width:20%;"><label class="required" for="address"><span
                                      class="Lhide">(필수)</span>
                                ...
                                <td colspan="3">
                                  <p class="currentLocation">
                                    <span>
                                      <input type="radio" id="currentLocation_domestic" name="address" value="A"
                                        checked="checked" /><label for="currentLocation_domestic">
                                        <LTag:message code="app.lbl.domesticAddress" />
                                      </label>
                                      <input type="radio" id="currentLocation_abroad" name="address" value="O" <c:if
                            ...
                            <span class="lineInPhone">
                              ...
                              <span class="input_search" id="countryDiv">
                                <input type="text" id="countryName" name="countryName" size="10"
                                  value="<c:out value='${applyMasterInfo.countryName}'/>" readonly="readonly"
                                  title="국적 검색" />
                                <input type="hidden" id="countryCode" name="countryCode"
                                  value="<c:out value='${applyMasterInfo.countryCode}'/>" />
                                <button type="button" onclick="searchCodePopup(this,'NA');">검색</button>
                              </span>
                              <input type="text" id="postalCode" name="postalCode" class="zipcode" size="10"
                                value="<c:out value='${applyMasterInfo.postalCode}'/>" readonly="readonly"
                                maxlength="20" title="<LTag:message code=" com.lbl.postCode" />" />
                            </span>
                            <input type="text" id="addressLine1Info" name="addressLine1Info" class="mainAddress"
                              size="40" value="<c:out value='${applyMasterInfo.addressLine1Info}'/>" readonly="readonly"
                              maxlength="1000" title="주소" />
                            </p>
                            <p class="currentLocation">
                              <input id="addressLine2Info" name="addressLine2Info" type="text" style="width:78.9%;"
                                size="60" value="<c:out value='${applyMasterInfo.addressLine2Info}' />" maxlength="1000"
                                title="상세 주소" placeholder="<LTag:message code='com.inf.006'/>" />
                            </p>
                            </td>
                            </tr>
                            </c:if>
                ...
                <div class="ddFoldedInPhone">
                  <div class="LblockDetailTable">
                    <table class="applicationform rsp rsp-hori rsp-tablet">
                      ...
                      <tbody>
                        <tr>
                          <th scope="row" style="width:15%"><label class="required" for="applychannelCode">
                              <LTag:message code="app.lbl.applyChannel" />
                            </label></th>
                          <td style="width:35%">
                            <span class="set_selectInput">
                              <select id="applychannelCode" name="applychannelCode" class="minwidth100"
                                style="min-width: 220px;">
                                <option value="">
                                  <LTag:message code="app.lbl.select" />
                                </option>
                                <c:forEach items="${applyChannelList.code}" varStatus="l">
                                  <option value="<c:out value='${applyChannelList.code[l.index]}' />" <c:if
                                    test="${applyChannelList.code[l.index] == baseInfo.applychannelCode }">
                                    selected </c:if>>
                                    <c:out value='${applyChannelList.value[l.index]}' />
                                  </option>
                                </c:forEach>
                              </select>
                            </span>
                          </td>
                          <th scope="row" style="width:15%" id="channelDetail"><label class="required"
                              for="applychannelDetailText">
                              <LTag:message code="app.lbl.applyChannelDetail" />
                            </label></th>
                          <td style="width:35%" id="channelDetailInput">
                            <input title="지원채널 상세내용" type="text" id="applychannelDetailText" class="blockInPhone"
                              name="applychannelDetailText" size="10" style="width:79%;"
                              value="<c:out value='${baseInfo.applychannelDetailText}' />" maxlength="100" />
                          </td>
                          <th scope="row" style="width:15%" id="applyPlatform"><label class="required"
                              for="applyplatformCode">
                          ...
                          <td style="width:35%" id="applyPlatformSelect">
                            ...
                            <input title="기타 플랫폼" type="text" id="applyplatformEtc" class="blockInPhone"
                              name="applyplatformEtc" size="10" style="width:30%;"
                              value="<c:out value='${baseInfo.applyplatformEtc}' />" maxlength="100" />
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <div class="ddFoldedInPhone">
                      <div class="LblockDetailTable">
                        <table class="applicationform rsp rsp-hori rsp-tablet">
                          ...
                          <tbody>
                            <tr>
                              <th scope="row" style="width:15%"><label for="milDischargeCode" class="required"><span
                                    class="Lhide">(필수)</span>
                              ...
                              <td style="width:35%">
                                <select id="milDischargeCode" name="milDischargeCode">
                                  ...
                                  <c:forEach items="${militaryDisChanList.code}" varStatus="i">
                                    <option value="<c:out value='${militaryDisChanList.code[i.index]}'/>" <c:if
              ...
              <tr>
                ...
                <td style="width:35%">
                  <input type="text" class="Ltext" id="milStartDate" name="milStartDate" size="11"
                    value="<c:out value='${baseInfo.milStartDate}' />" readonly="readonly" title="<LTag:message code="
                    app.lbl.milPeriodDate" /> 시작일">
                  ...
                  <input type="text" class="Ltext" id="milEndDate" name="milEndDate" size="11"
                    value="<c:out value='${baseInfo.milEndDate}' />" readonly="readonly" title="<LTag:message code="
                    app.lbl.milPeriodDate" /> 종료일">
                  <button type="button" id="milEndDate_cal" class="LiconCalendar" data-calendar="milEndDate">달력</button>
                </td>
              </tr>
              <tr>
                ...
                <th scope="row" style="width:15%" class="crapInto1Line"><label for="milExmptDetailReason">
                    <LTag:message code="app.lbl.milExmptDetailReason" />
                  </label></th>
                <td style="width:35%">
                  <input type="text" id="milExmptDetailReason" name="milExmptDetailReason"
                    value="<c:out value='${baseInfo.milExmptDetailReason}' />" maxlength="50" disabled="disabled" />
                </td>
              </tr>
              </tbody>
              </table>
            ...
            <div class="ddFoldedInPhone">
              <div class="LblockDetailTable">
                <table class="applicationform rsp rsp-hori rsp-tablet">
                  ...
                  <tbody>
                    <tr>
                      <th scope="row" style="width:15%;"><label class="required" for="veteranTypeCode"><span
                            class="Lhide">(필수)</span>
                      ...
                      <td style="width:35%;">
                        <select id="veteranTypeCode" name="veteranTypeCode">
                          ...
                          <c:forEach items="${veteranTypeList.code}" varStatus="i">
                            <option value="<c:out value='${veteranTypeList.code[i.index]}' />" <c:if
        ...
        <tr>
          ...
          <td style="width:35%;">
            <input type="radio" id="veteranEmploymentFlag_yes" name="veteranEmploymentFlag" disabled="disabled"
              value="Y" <c:if test="${baseInfo.veteranEmploymentFlag=='Y'}">
            checked="checked" </c:if> ><label for="engineeringAccrFlag_yes">Yes</label>
            <input type="radio" id="veteranEmploymentFlag_no" name="veteranEmploymentFlag" disabled="disabled" value="N"
              <c:if test="${baseInfo.veteranEmploymentFlag!='Y'}">
        ...
        <%-- FPT - Static Analysis Handle - DELETE --%>
          ...
          <c:if test="${jobNoticeInfo.recruitTypeCode == 'D' || jobNoticeInfo.recruitTypeCode == 'H'}">
            <div class="LblockTabButton">
              ...
              <div class="LblockApplyAgree" style="display: inline-block; margin-right: 15px; font-weight: bold; ">
                ...
                <c:if
                  ...
                  <div class="LblockPageLink">
                    <p id="beforeDetail" class="links">
                      <LTag:message code="app.cont.topCont_1" /> <a href="#" onClick="retrieveBeforeDetailInfo();">
                ...
                <div class="dtFoldedInPhone btnmore">
                  <div class="LblockPageSubtitle">
                    ...
                    <div class="subtitleBtn">
                      <a href="#" class="btn_erase" onclick="fnEraseData('elemschoolDiv');"><span class="Lhide">
                ...
                <div class="ddFoldedInPhone">
                  <div class="LblockDetailTable">
                    <table class="applicationform rsp rsp-hori rsp-tablet">
                      ...
                      <tbody>
                        <tr>
                          <th scope="row" style="width:15%;"><label class="required" for="elemSchoolName"><span
                                class="Lhide">(필수)</span>
                              <LTag:message code="app.lbl.schoolName" />
                            </label></th>
                          <td style="width:35%;">
                            <div class="input_search">
                              <input type="text" id="elemSchoolName" name="elemSchoolName" size="10" readonly="readonly"
                                value="<c:out value='${elemInfo.schoolName}' />" />
                              <input type="hidden" id="elemSchoolCode" name="elemSchoolCode"
                                value="<c:out value='${elemInfo.schoolCode}' />" />
                              <button type="button" onclick="searchSchoolPopup(this,'E');">검색</button>
                            </div>
                          </td>
                          <th scope="row" style="width:15%;"><label class="required" for="elemLocationName"><span
                                class="Lhide">(필수)</span>
                              <LTag:message code="app.lbl.locationName" />
                            </label></th>
                          <td style="width:35%;">
                            <div class="input_search">
                              <input type="text" id="elemLocationName" name="elemLocationName" size="10"
                                value="<c:out value='${elemInfo.locationName}' />" readonly="readonly"
                                maxlength="300" />
                              <input type="hidden" id="elemAddressSido" name="elemAddressSido"
                                value="<c:out value='${elemInfo.addressSido}' />" />
                              <input type="hidden" id="elemAddressSigu" name="elemAddressSigu"
                        ...
                        <tr>
                          <th scope="row" style="width:15%;"><label class="required"><span class="Lhide">(필수)</span>
                              <LTag:message code="app.lbl.preriodDate" />
                            </label></th>
                          <td style="width:35%;">
                            <input type="text" class="Ltext" id="elemstartDate" name="elemstartDate"
                              value="<c:out value='${elemInfo.startDate}' />" size="11" maxlength="11"
                              readonly="readonly" title="<LTag:message code=" app.lbl.preriodDate" /> 시작일" />
                            <button type="button" class="LiconCalendar" data-calendar="elemstartDate">달력</button>
                            <label>~</label>
                            <input type="text" class="Ltext" id="elemendDate" name="elemendDate" size="11"
                              value="<c:out value='${elemInfo.endDate}' />" maxlength="11" readonly="readonly"
                              title="<LTag:message code=" app.lbl.preriodDate" /> 종료일" />
                            <button type="button" class="LiconCalendar" data-calendar="elemendDate">달력</button>
                          </td>
                          <th scope="row" style="width:15%;"><label class="required"
                              for="elemGraduationStatusCode"><span class="Lhide">(필수)</span>
                              <LTag:message code="app.lbl.graduationFlag" />
                            </label></th>
                          <td style="width:35%;">
                            <select id="elemGraduationStatusCode" name="elemGraduationStatusCode">
                              <option value="">
                                <LTag:message code="app.lbl.select" />
                              </option>
                              <c:forEach items="${graduationList.code}" varStatus="i">
                                <option value="<c:out value='${graduationList.code[i.index]}' />" <c:if
              ...
              <div class="foldedInphone">
                <div class="dtFoldedInPhone btnmore">
                  <div class="LblockPageSubtitle">
                    ...
                    <div class="subtitleBtn">
                      <a href="#" class="btn_erase" onclick="fnEraseData('middleschoolDiv');"><span class="Lhide">
                ...
                <div class="ddFoldedInPhone">
                  <div class="LblockDetailTable">
                    <table class="applicationform rsp rsp-hori rsp-tablet">
                      ...
                      <tbody>
                        <tr>
                          <th scope="row" style="width:15%;"><label class="required" for="middleSchoolName"><span
                                class="Lhide">(필수)</span>
                              <LTag:message code="app.lbl.schoolName" />
                            </label></th>
                          <td style="width:35%;">
                            <div class="input_search">
                              <input type="text" id="middleSchoolName" name="middleSchoolName" size="10"
                                readonly="readonly" value="<c:out value='${middleInfo.schoolName}' />" />
                              <input type="hidden" id="middleSchoolCode" name="middleSchoolCode"
                                value="<c:out value='${middleInfo.schoolCode}' />" />
                              <button type="button" onclick="searchSchoolPopup(this,'D');">검색</button>
                            </div>
                          </td>
                          <th scope="row" style="width:15%;"><label class="required" for="middleLocationName"><span
                                class="Lhide">(필수)</span>
                              <LTag:message code="app.lbl.locationName" />
                            </label></th>
                          <td style="width:35%;">
                            <div class="input_search">
                              <input type="text" id="middleLocationName" name="middleLocationName" size="10"
                                value="<c:out value='${middleInfo.locationName}' />" readonly="readonly"
                                maxlength="300" />
                              <input type="hidden" id="middleAddressSido" name="middleAddressSido"
                                value="<c:out value='${middleInfo.addressSido}' />" />
                              <input type="hidden" id="middleAddressSigu" name="middleAddressSigu"
                        ...
                        <tr>
                          ...
                          <td style="width:35%;">
                            <input type="text" class="Ltext" id="middlestartDate" name="middlestartDate"
                              value="<c:out value='${middleInfo.startDate}' />" size="11" maxlength="11"
                              readonly="readonly" title="<LTag:message code=" app.lbl.preriodDate" /> 시작일" />
                            <button type="button" class="LiconCalendar" data-calendar="middlestartDate">달력</button>
                            <label>~</label>
                            <input type="text" class="Ltext" id="middleendDate" name="middleendDate" size="11"
                              value="<c:out value='${middleInfo.endDate}' />" maxlength="11" readonly="readonly"
                              title="<LTag:message code=" app.lbl.preriodDate" /> 종료일" />
                            <button type="button" class="LiconCalendar" data-calendar="middleendDate">달력</button>
                          </td>
                          <th scope="row" style="width:15%;"><label class="required"
                              for="middleGraduationStatusCode"><span class="Lhide">(필수)</span>
                              <LTag:message code="app.lbl.graduationFlag" />
                            </label></th>
                          <td style="width:35%;">
                            <select id="middleGraduationStatusCode" name="middleGraduationStatusCode">
                              <option value="">
                                <LTag:message code="app.lbl.select" />
                              </option>
                              <c:forEach items="${graduationList.code}" varStatus="i">
              ...
              <div class="foldedInphone">
                <div class="dtFoldedInPhone btnmore">
                  <div class="LblockPageSubtitle">
                    ...
                    <div class="subtitleBtn">
                      <a href="#" class="btn_erase" onclick="fnEraseData('highschoolDiv');"><span class="Lhide">
                ...
                <div class="ddFoldedInPhone">
                  <div class="LblockDetailTable">
                    <table class="applicationform rsp rsp-hori rsp-tablet">
                      ...
                      <tbody>
                        <tr>
                          <th scope="row" style="width:15%;"><label class="required" for="highSchoolName"><span
                                class="Lhide">(필수)</span>
                              <LTag:message code="app.lbl.schoolName" />
                            </label></th>
                          <td style="width:35%;">
                            <div class="input_search">
                              <input type="text" id="highSchoolName" name="highSchoolName" size="10" readonly="readonly"
                                value="<c:out value='${highInfo.schoolName}' />" />
                              <input type="hidden" id="highSchoolCode" name="highSchoolCode"
                                value="<c:out value='${highInfo.schoolCode}' />" />
                              <button type="button" onclick="searchSchoolPopup(this,'H');">검색</button>
                            </div>
                          </td>
                          <th scope="row" style="width:15%;"><label class="required" for="highLocationName"><span
                                class="Lhide">(필수)</span>
                              <LTag:message code="app.lbl.locationName" />
                            </label></th>
                          <td style="width:35%;">
                            <div class="input_search">
                              <input type="text" id="highLocationName" name="highLocationName" size="10"
                                value="<c:out value='${highInfo.locationName}' />" readonly="readonly"
                                maxlength="300" />
                              <input type="hidden" id="highAddressSido" name="highAddressSido"
                                value="<c:out value='${highInfo.addressSido}' />" />
                              <input type="hidden" id="highAddressSigu" name="highAddressSigu"
                        ...
                        <tr>
                          ...
                          <td style="width:35%;">
                            <input type="text" class="Ltext" id="highstartDate" name="highstartDate"
                              value="<c:out value='${highInfo.startDate}' />" size="11" maxlength="11"
                              readonly="readonly" title="<LTag:message code=" app.lbl.preriodDate" /> 시작일" />
                            <button type="button" class="LiconCalendar" data-calendar="highstartDate">달력</button>
                            <label>~</label>
                            <input type="text" class="Ltext" id="highendDate" name="highendDate" size="11"
                              value="<c:out value='${highInfo.endDate}' />" maxlength="11" readonly="readonly"
                              title="<LTag:message code=" app.lbl.preriodDate" /> 종료일" />
                            <button type="button" class="LiconCalendar" data-calendar="highendDate">달력</button>
                          </td>
                          <th scope="row" style="width:15%;"><label class="required"
                              for="highGraduationStatusCode"><span class="Lhide">(필수)</span>
                              <LTag:message code="app.lbl.graduationFlag" />
                            </label></th>
                          <td style="width:35%;">
                            <select id="highGraduationStatusCode" name="highGraduationStatusCode">
                              <option value="">
                                <LTag:message code="app.lbl.select" />
                              </option>
                              <c:forEach items="${graduationList.code}" varStatus="i">
          ...
          <c:if test="${jobNoticeInfo.highschRankInputFlag == 'N' || jobNoticeInfo.highschAttendInputFlag == 'N'}">
            <tr>
              ...
              <td colspan="3" style="width:85%;" class="td_file">
                <div class="set_selectInput hiddenInPhone hiddenInTablet">
                  ...
                  <input type="hidden" id="highattachFileId_${i.index+1}" name="highattachFileId_${i.index+1}"
                  ...
                  <ul id="highThesis_${i.index+1}" class="LblockItemList Lfile">
                    <c:forEach items="${schoolFileList.attachFileId}" varStatus="k">
                      <c:if test="${schoolFileList.attachFileId[k.index] == highInfo.attachFileId}">
                        <li style="">
                          <p><a href="javascript:;"
                            ...
                            </a><button type='button' onclick='deleteItem(this);'>삭제</button></p>
                          <input type="hidden" id="fileSeqNo" name="fileSeqNo"
              ...
              <div class="foldedInphone">
                <div class="dtFoldedInPhone btnmore">
                  <div class="LblockPageSubtitle">
                    ...
                    <div class="subtitleBtn">
                      <a href="#" class="btn_erase" onclick="fnEraseData('highschAttendDiv');"><span class="Lhide">
                    ...
                    <table class="applyformHeaderTop rsp rsp-basic">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th scope="col" style="width:22%;" colspan="3"><label class="required" for="">결석일수</label>
                          </th>
                          <th scope="col" style="width:22%;" colspan="3"><label class="required" for="">지각</label></th>
                          <th scope="col" style="width:22%;" colspan="3"><label class="required" for="">조퇴</label></th>
                          <th scope="col" style="width:22%;" colspan="3"><label class="required" for="">결과</label></th>
                        </tr>
                        <tr>
                          <th scope="col" style="width:7%;" title="결석일수-질병"><label class="required"
                              for="attendabsentDis">질병</label></th>
                          <th scope="col" style="width:7%;" title="결석일수-무단"><label class="required"
                              for="attendabsentNot">무단</label></th>
                          <th scope="col" style="width:8%;" title="결석일수-기타"><label class="required"
                              for="attendabsentEtc">기타</label></th>
                          <th scope="col" style="width:7%;" title="지각-질병"><label class="required"
                              for="attendlateDis">질병</label></th>
                          <th scope="col" style="width:7%;" title="지각-무단"><label class="required"
                              for="attendlateNot">무단</label></th>
                          <th scope="col" style="width:8%;" title="지각-기타"><label class="required"
                              for="attendlateEtc">기타</label></th>
                          <th scope="col" style="width:7%;" title="조퇴-질병"><label class="required"
                              for="attendshortDis">질병</label></th>
                          <th scope="col" style="width:7%;" title="조퇴-무단"><label class="required"
                              for="attendshortNot">무단</label></th>
                          <th scope="col" style="width:8%;" title="조퇴-기타"><label class="required"
                              for="attendshortEtc">기타</label></th>
                          <th scope="col" style="width:7%;" title="결과-질병"><label class="required"
                              for="attendmissedDis">질병</label></th>
                          <th scope="col" style="width:7%;" title="결과-무단"><label class="required"
                              for="attendmissedNot">무단</label></th>
                          <th scope="col" style="width:8%;" title="결과-기타"><label class="required"
                              for="attendmissedEtc">기타</label></th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td style="width:12%;">전체합계</td>
                          <td style="width:7%;"><input type="text" id="attendabsentDis" name="attendabsentDis"
                              value="<c:out value='${highschAttendInfo.absentDis[0]}'/>" size="5" maxlength="3"
                              title="질병" onKeyPress="return $.onKeyPressFilter('[0-9]', event);"
                              style="ime-mode:disabled;" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"></td>
                          <td style="width:7%;"><input type="text" id="attendabsentNot" name="attendabsentNot"
                              value="<c:out value='${highschAttendInfo.absentNot[0]}'/>" size="5" maxlength="3"
                              title="무단" onKeyPress="return $.onKeyPressFilter('[0-9]', event);"
                              style="ime-mode:disabled;" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"></td>
                          <td style="width:8%;"><input type="text" id="attendabsentEtc" name="attendabsentEtc"
                              value="<c:out value='${highschAttendInfo.absentEtc[0]}'/>" size="5" maxlength="3"
                              title="기타" onKeyPress="return $.onKeyPressFilter('[0-9]', event);"
                              style="ime-mode:disabled;" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"></td>
                          <td style="width:7%;"><input type="text" id="attendlateDis" name="attendlateDis"
                              value="<c:out value='${highschAttendInfo.lateDis[0]}'/>" size="5" maxlength="3" title="질병"
                              onKeyPress="return $.onKeyPressFilter('[0-9]', event);" style="ime-mode:disabled;"
                              onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"></td>
                          <td style="width:7%;"><input type="text" id="attendlateNot" name="attendlateNot"
                              value="<c:out value='${highschAttendInfo.lateNot[0]}'/>" size="5" maxlength="3" title="무단"
                              onKeyPress="return $.onKeyPressFilter('[0-9]', event);" style="ime-mode:disabled;"
                              onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"></td>
                          <td style="width:8%;"><input type="text" id="attendlateEtc" name="attendlateEtc"
                              value="<c:out value='${highschAttendInfo.lateEtc[0]}'/>" size="5" maxlength="3" title="기타"
                              onKeyPress="return $.onKeyPressFilter('[0-9]', event);" style="ime-mode:disabled;"
                              onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"></td>
                          <td style="width:7%;"><input type="text" id="attendshortDis" name="attendshortDis"
                              value="<c:out value='${highschAttendInfo.shortDis[0]}'/>" size="5" maxlength="3"
                              title="질병" onKeyPress="return $.onKeyPressFilter('[0-9]', event);"
                              style="ime-mode:disabled;" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"></td>
                          <td style="width:7%;"><input type="text" id="attendshortNot" name="attendshortNot"
                              value="<c:out value='${highschAttendInfo.shortNot[0]}'/>" size="5" maxlength="3"
                              title="무단" onKeyPress="return $.onKeyPressFilter('[0-9]', event);"
                              style="ime-mode:disabled;" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"></td>
                          <td style="width:8%;"><input type="text" id="attendshortEtc" name="attendshortEtc"
                              value="<c:out value='${highschAttendInfo.shortEtc[0]}'/>" size="5" maxlength="3"
                              title="기타" onKeyPress="return $.onKeyPressFilter('[0-9]', event);"
                              style="ime-mode:disabled;" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"></td>
                          <td style="width:7%;"><input type="text" id="attendmissedDis" name="attendmissedDis"
                              value="<c:out value='${highschAttendInfo.missedDis[0]}'/>" size="5" maxlength="3"
                              title="질병" onKeyPress="return $.onKeyPressFilter('[0-9]', event);"
                              style="ime-mode:disabled;" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"></td>
                          <td style="width:7%;"><input type="text" id="attendmissedNot" name="attendmissedNot"
                              value="<c:out value='${highschAttendInfo.missedNot[0]}'/>" size="5" maxlength="3"
                              title="무단" onKeyPress="return $.onKeyPressFilter('[0-9]', event);"
                              style="ime-mode:disabled;" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"></td>
                          <td style="width:8%;"><input type="text" id="attendmissedEtc" name="attendmissedEtc"
                              value="<c:out value='${highschAttendInfo.missedEtc[0]}'/>" size="5" maxlength="3"
                              title="기타" onKeyPress="return $.onKeyPressFilter('[0-9]', event);"
                              style="ime-mode:disabled;" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"></td>
                        </tr>
                      </tbody>
                    ...
                    <table class="applyformHeaderTop rsp rsp-basic">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th scope="col" style="width:13%;"><label class="required" for="attendschoolDays">수업일수</label>
                          </th>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td style="width:13%;"><input type="text" id="attendschoolDays" name="attendschoolDays"
                              value="<c:out value='${highschAttendInfo.schoolDays[0]}'/>" size="10" maxlength="3"
                              title="수업일수" onKeyPress="return $.onKeyPressFilter('[0-9]', event);"
                              style="ime-mode:disabled;" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"></td>
                          <td style="width:75%;"><input type="text" id="attendawardRecord" name="attendawardRecord"
                              value="<c:out value='${highschAttendInfo.awardRecord[0]}'/>" size="110" maxlength="100"
                              title="수상경력"></td>
                        </tr>
              ...
              <div class="foldedInphone">
                <div class="dtFoldedInPhone btnmore">
                  <div class="LblockPageSubtitle">
                    ...
                    <div class="subtitleBtn">
                      <a href="#" class="btn_erase" onclick="fnEraseData('highschRankDiv');"><span class="Lhide">
                          <LTag:message code="app.titl.highschAttend" /> 입력
                        </span>지우기</a>
                    </div>
                  </div>
                    ...
                    <table id="highschrankTable" class="applyformHeaderTop rsp rsp-basic">
                      ...
                      <thead>
                        <%-- FPT - Static Analysis Handle - DELETE --%>
                          <tr>
                            ...
                            <th scope="col"><label class="required" for="rankschCourseFrt">1학기 과목</label></th>
                            <th scope="col"><label class="required" for="rankschCreditFrt">단위수</label></th>
                            <th scope="col"><label class="required" for="rankschRankFrt">석차등급</label></th>
                            <th scope="col"><label class="required" for="rankschNosesFrt">수강인원</label></th>
                            <th scope="col"><label class="required" for="rankschCourseSnd">2학기 과목</label></th>
                            <th scope="col"><label class="required" for="rankschCreditSnd">단위수</label></th>
                            <th scope="col"><label class="required" for="rankschRankSnd">석차등급</label></th>
                            <th scope="col"><label class="required" for="rankschNosesSnd">수강인원</label></th>
                          </tr>
                      ...
                      <tbody>
                        <c:forEach items="${highschRankList.schoolGrade}" varStatus="i">
                          <tr>
                            <td><input type="hidden" id="rankschoolGrade_${i.index}" name="rankschoolGrade_${i.index}"
                            ...
                            <td><input type="text" id="rankschCreditFrt_${i.index}" name="rankschCreditFrt_${i.index}"
                                ...
                                maxlength="5" title="단위수"></td>
                            <td><input type="text" id="rankschRankFrt_${i.index}" name="rankschRankFrt_${i.index}"
                                value="<c:out value='${highschRankList.schRankFrt[i.index]}'/>" size="10" maxlength="5"
                                title="석차등급"></td>
                            <td><input type="text" id="rankschNosesFrt_${i.index}" name="rankschNosesFrt_${i.index}"
                                value="<c:out value='${highschRankList.schNosesFrt[i.index]}'/>" size="10" maxlength="5"
                                title="수강수"></td>
                            <td><input type="text" id="rankschCourseSnd_${i.index}" name="rankschCourseSnd_${i.index}"
                                value="<c:out value='${highschRankList.schCourseSnd[i.index]}'/>" size="10"
                                maxlength="8" title="과목"></td>
                            <td><input type="text" id="rankschCreditSnd_${i.index}" name="rankschCreditSnd_${i.index}"
                                value="<c:out value='${highschRankList.schCreditSnd[i.index]}'/>" size="10"
                                maxlength="5" title="단위수"></td>
                            <td><input type="text" id="rankschRankSnd_${i.index}" name="rankschRankSnd_${i.index}"
                                value="<c:out value='${highschRankList.schRankSnd[i.index]}'/>" size="10" maxlength="5"
                                title="석차등급"></td>
                            <td><input type="text" id="rankschNosesSnd_${i.index}" name="rankschNosesSnd_${i.index}"
                                value="<c:out value='${highschRankList.schNosesSnd[i.index]}'/>" size="10" maxlength="5"
                                title="수강수"></td>
                          </tr>
                        </c:forEach>
                      </tbody>
            ...
            <div class="foldedInphone">
              <div class="dtFoldedInPhone btnmore">
                <div class="LblockPageSubtitle more">
                  ...
                  <div class="subtitleBtn">
                    <a href="#" class="btn_erase" onclick="fnEraseData('collegeDiv');"><span class="Lhide">
              ...
              <div class="ddFoldedInPhone">
                <c:forEach items="${collegeInfo.jobNoticeId}" varStatus="i">
                  <c:if test="${i.index != 0}">
                    <div class="btn_deleteTable"><button type="button" onClick="delDataInfo(this,'coll');">다음 항목
                        삭제</button></div>
                  </c:if>
                  <div class="LblockDetailTable">
                    <%-- 비즈니스 로직에서 학교이름의 키를 파싱해서 숫자를 세므로 학교이름이 필수가 아닌 상황에서 로직을 맞춰주기위해 순번을 넣음. --%>
                      <input type="hidden" id="collegeschoolSeqno_${i.index+1}" name="collegeschoolSeqno_${i.index+1}"
                        value="${i.index+1}" />
                      <table class="applicationform rsp rsp-hori rsp-tablet">
                        <caption>
                          <LTag:message code="app.lbl.college" />
                          ...
                          <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                            <%-- 학교명 / 소재지 표시 --%>
                              <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                                ...
                                <c:choose>
                                  <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\" SCHOOL_NAME\"') &&
                                    ...
                                    <%-- 학교명, 소재지 모두 입력받음 --%>
                                      ...
                                      <tr>
                                        <th scope="row"><label class="required"
                                            for="collegeschoolName_${i.index+1}"><span class="Lhide">(필수)</span>
                                            <LTag:message code="app.lbl.schoolName" />
                                          </label></th>
                                        <td>
                                          <div class="input_search">
                                            <input type="text" id="collegeschoolName_${i.index+1}"
                                              name="collegeschoolName_${i.index+1}" size="10" readonly="readonly"
                                              value="<c:out value='${collegeInfo.schoolName[i.index]}' />" />
                                            <input type="hidden" id="collegeschoolCode_${i.index+1}"
                                              name="collegeschoolCode_${i.index+1}"
                                              value="<c:out value='${collegeInfo.schoolCode[i.index]}' />" />
                                            <button type="button" onclick="searchSchoolPopup(this,'C');">검색</button>
                                          </div>
                                        </td>
                                        <th scope="row"><label class="required"
                                            for="collegelocationName_${i.index+1}"><span class="Lhide">(필수)</span>
                                            <LTag:message code="app.lbl.locationName" />
                                          </label></th>
                                        <td>
                                          <div class="input_search">
                                            <input type="text" id="collegelocationName_${i.index+1}"
                                              name="collegelocationName_${i.index+1}"
                                              value="<c:out value='${collegeInfo.locationName[i.index]}' />"
                                              readonly="readonly" maxlength="300" />
                                            <input type="hidden" id="collegeaddressSido_${i.index+1}"
                                              name="collegeaddressSido_${i.index+1}"
                                              value="<c:out value='${collegeInfo.addressSido[i.index]}' />" />
                                            <input type="hidden" id="collegeaddressSigu_${i.index+1}"
                                  ...
                                  <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\" LOCATION\"')}">
                                ...
                                <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                                  <%-- 기간 / 졸업구분 표시 --%>
                                    <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                                      ...
                                      <c:choose>
                                        <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\" PERIOD\"') &&
                                          ...
                                          <%-- 기간, 졸업구분 모두 입력받음 --%>
                                            ...
                                            <tr>
                                              <th scope="row"><label class="required"
                                                  for="collegestartDate_${i.index+1}"><span class="Lhide">(필수)</span>
                                                  <LTag:message code="app.lbl.preriodDate" />
                                                </label></th>
                                              <td>
                                                <input type="text" class="Ltext" id="collegestartDate_${i.index+1}"
                                                  name="collegestartDate_${i.index+1}"
                                                  value="<c:out value='${collegeInfo.startDate[i.index]}' />" size="11"
                                                  maxlength="11" readonly="readonly" title="기간 시작일" />
                                                <button type="button" class="LiconCalendar"
                                                  id="collegestartCal_${i.index+1}"
                                                  data-calendar="collegestartDate_${i.index+1}">달력</button>
                                                <label>~</label>
                                                <input type="text" class="Ltext" id="collegeendDate_${i.index+1}"
                                                  name="collegeendDate_${i.index+1}"
                                                  value="<c:out value='${collegeInfo.endDate[i.index]}' />" size="11"
                                                  maxlength="11" readonly="readonly" title="기간 종료일" />
                                                <button type="button" class="LiconCalendar"
                                              ...
                                              <td>
                                                <select id="collegegraduationStatusCode_${i.index+1}"
                                                  name="collegegraduationStatusCode_${i.index+1}">
                                                  <option value="">
                                                    <LTag:message code="app.lbl.select" />
                                                  </option>
                                                  <c:forEach items="${graduationList.code}" varStatus="l">
                                                    <option value="<c:out value='${graduationList.code[l.index]}' />"
                                                      <c:if
                                                      test="${collegeInfo.graduationStatusCode[i.index] == graduationList.code[l.index]}">
                                                      selected
                                                      </c:if>>
                                                      <c:out value='${graduationList.value[l.index]}' />
                                                    </option>
                                                  </c:forEach>
                                                </select>
                                              </td>
                                        ...
                                        <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\"
                                          GRADUATION_STATUS\"')}">
                                            ...
                                            <c:choose>
                                              <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\"
                                                ...
                                                <%-- 전공명, 전체평점 모두 입력받음 --%>
                                                  ...
                                                  <tr>
                                                    <th scope="row">
                                                      <label class="required" for="collegemajorName_${i.index+1}"><span
                                                          class="Lhide">(필수)</span>
                                                        <LTag:message code="app.lbl.majorName" />
                                                      </label>
                                                    </th>
                                                    <td>
                                                      <div class="input_search">
                                                        <input type="text" id="collegemajorName_${i.index+1}"
                                                          name="collegemajorName_${i.index+1}" size="25"
                                                          readonly="readonly"
                                                          value="<c:out value='${collegeInfo.majorName[i.index]}' />" />
                                                        <input type="hidden" id="collegemajorCode_${i.index+1}"
                                                    ...
                                                    <th scope="row">
                                                      <label class="required" for="collegegpaPoint_${i.index+1}"><span
                                                          class="Lhide">(필수)</span>
                                                        <LTag:message code="app.lbl.gpaPoint" />
                                                      </label>
                                                    </th>
                                                    <td>
                                                      <span class="set_selectInput">
                                                        <input type="text" id="collegegpaPoint_${i.index+1}"
                                                        ...
                                                        /
                                                        <select title="학점 총점" id="collegegpaPointCode_${i.index+1}"
                                                          name="collegegpaPointCode_${i.index+1}"
                                                          onChange="getText(this)">
                                                          <option value="">
                                                            <LTag:message code="app.lbl.select" />
                                                          </option>
                                                          <c:forEach items="${gpaTypeList.code}" varStatus="k">
                                                            <option
                                                              ...
                                                              >
                                                              <c:out value='${gpaTypeList.value[k.index]}' />
                                                            </option>
                                                          </c:forEach>
                                                        </select>
                                                        <input type="hidden" id="collegegpaPointCodeVal_${i.index+1}"
            ...
            <div class="foldedInphone">
              <div class="dtFoldedInPhone btnmore">
                <div class="LblockPageSubtitle more">
                  ...
                  <div class="subtitleBtn">
                    <a href="#" class="btn_erase" onclick="fnEraseData('uniDiv');"><span class="Lhide">
              ...
              <div class="ddFoldedInPhone">
                <c:forEach items="${uniInfo.jobNoticeId}" varStatus="i">
                  <c:if test="${i.index != 0}">
                    <div class="btn_deleteTable"><button type="button" onClick="delDataInfo(this,'uni');">다음 항목
                        삭제</button></div>
                  </c:if>
                  <div class="LblockDetailTable">
                    <%-- 비즈니스 로직에서 학교이름의 키를 파싱해서 숫자를 세므로 학교이름이 필수가 아닌 상황에서 로직을 맞춰주기위해 순번을 넣음. --%>
                      <input type="hidden" id="unischoolSeqno_${i.index+1}" name="unischoolSeqno_${i.index+1}"
                        value="${i.index+1}" />
                      <table class="applicationform rsp rsp-hori rsp-tablet">
                        <caption>
                          <LTag:message code="app.titl.uni" />
                                ...
                                <c:choose>
                                  <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\" SCHOOL_NAME\"') &&
                                    ...
                                    <%-- 학교명, 소재지 모두 입력받음 --%>
                                      ...
                                      <tr>
                                        <th scope="row"><label class="required" for="unischoolName_${i.index+1}"><span
                                              class="Lhide">(필수)</span>
                                            <LTag:message code="app.lbl.schoolName" />
                                          </label></th>
                                        <td>
                                          <div class="input_search">
                                            <input type="text" id="unischoolName_${i.index+1}"
                                              name="unischoolName_${i.index+1}" size="10" readonly="readonly"
                                              value="<c:out value='${uniInfo.schoolName[i.index]}' />" />
                                            <input type="hidden" id="unischoolCode_${i.index+1}"
                                              name="unischoolCode_${i.index+1}"
                                              value="<c:out value='${uniInfo.schoolCode[i.index]}' />" />
                                            <button type="button" onclick="searchSchoolPopup(this,'U');">검색</button>
                                          </div>
                                        </td>
                                        <th scope="row"><label class="required" for="unilocationName_${i.index+1}"><span
                                              class="Lhide">(필수)</span>
                                            <LTag:message code="app.lbl.locationName" />
                                          </label></th>
                                        <td>
                                          <div class="input_search">
                                            <input type="text" id="unilocationName_${i.index+1}"
                                              name="unilocationName_${i.index+1}"
                                              value="<c:out value='${uniInfo.locationName[i.index]}' />"
                                              readonly="readonly" maxlength="300" />
                                            <input type="hidden" id="uniaddressSido_${i.index+1}"
                                              name="uniaddressSido_${i.index+1}"
                                              value="<c:out value='${uniInfo.addressSido[i.index]}' />" />
                                            <input type="hidden" id="uniaddressSigu_${i.index+1}"
                                      ...
                                      <c:choose>
                                        <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\" PERIOD\"') &&
                                          ...
                                          <%-- 기간, 졸업구분 모두 입력받음 --%>
                                            ...
                                            <tr>
                                              <th scope="row"><label class="required"
                                                  for="unistartDate_${i.index+1}"><span class="Lhide">(필수)</span>
                                                  <LTag:message code="app.lbl.preriodDate" />
                                                </label></th>
                                              <td>
                                                <input type="text" class="Ltext" id="unistartDate_${i.index+1}"
                                                  name="unistartDate_${i.index+1}" size="11" maxlength="11"
                                                  readonly="readonly"
                                                ...
                                                <label>~</label>
                                                <input type="text" class="Ltext" id="uniendDate_${i.index+1}"
                                                  name="uniendDate_${i.index+1}" size="11" maxlength="11"
                                                  readonly="readonly"
                                                  value="<c:out value='${uniInfo.endDate[i.index]}' />"
                                                  title="기간 종료일" />
                                                <button type="button" class="LiconCalendar" id="uniendCal_${i.index+1}"
                                              ...
                                              <td>
                                                <select id="unigraduationStatusCode_${i.index+1}"
                                          ...
                                          <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                                            ...
                                            <c:choose>
                                              <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\"
                                                ...
                                                <%-- 전공명, 부복수전공 구분 모두 입력받음 --%>

                                                  <tr>
                                                    <th scope="row">
                                                      <label class="required" for="unimajorName_${i.index+1}"><span
                                                          class="Lhide">(필수)</span>
                                                        <LTag:message code="app.lbl.majorName" />
                                                      </label>
                                                    </th>
                                                    <td>
                                                      <div class="input_search">
                                                        <input type="text" id="unimajorName_${i.index+1}"
                                                          name="unimajorName_${i.index+1}" size="10" readonly="readonly"
                                                          value="<c:out value='${uniInfo.majorName[i.index]}' />" />
                                                        <input type="hidden" id="unimajorCode_${i.index+1}"
                                                    ...
                                                    <th scope="row">
                                                      <label for="uniminorType_${i.index+1}">
                                                        <LTag:message code="app.lbl.minorName" />
                                                      </label>
                                                    </th>
                                                    <td>
                                                      <span class="set_selectInput">
                                                        <select id="uniminorType_${i.index+1}"
                                                          name="uniminorType_${i.index+1}" title="부/복수전공 선택"
                                                          class="minwidth100" <c:if
                                                          ...
                                                          <c:forEach items="${minorTypeList.code}" varStatus="z">
                                                            <option
                                                              ...
                                                              >
                                                              <c:out value='${minorTypeList.value[z.index]}' />
                                                            </option>
                                                          </c:forEach>

                                                        </select>
                                                        <span class="input_search">
                                                          <input type="text" id="uniminorName_${i.index+1}"
                                                            name="uniminorName_${i.index+1}"
                                                            value="<c:out value='${uniInfo.minorName[i.index]}' />"
                                                            size="10" readonly="readonly" title="전공명" />
                                                          <input type="hidden" id="uniminorCode_${i.index+1}"
                                            ...
                                            <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                                              <%-- 전체평점 표시 --%>
                                                <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                                                    ...
                                                    <tr>
                                                      <c:choose>
                                                        <c:when test="${jobNoticeInfo.careerTypeCode=='B'}">
                                                          <th scope="row">
                                                            <label for="unigpaPoint_${i.index+1}">
                                                              <LTag:message code="app.lbl.gpaPoint" />
                                                            </label>
                                                          </th>
                                                        </c:when>
                                                        <c:otherwise>
                                                          <th scope="row">
                                                            <label class="required" for="unigpaPoint_${i.index+1}"><span
                                                                class="Lhide">(필수)</span>
                                                              <LTag:message code="app.lbl.gpaPoint" />
                                                            </label>
                                                          </th>
                                                      ...
                                                      <td colspan="3">
                                                        <span class="set_selectInput">
                                                          <input type="text" id="unigpaPoint_${i.index+1}"
                                                            name="unigpaPoint_${i.index+1}" size="3"
                                                            ...
                                                            onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
                                                          /
                                                          <select title="전체평점" id="unigpaPointCode_${i.index+1}"
                                                            name="unigpaPointCode_${i.index+1}"
                                                            onChange="getText(this)">
                                                            <option value="">
                                                              <LTag:message code="app.lbl.select" />
                                                            </option>
                                                            <c:forEach items="${gpaTypeList.code}" varStatus="u">
                                                              <option
                                                  ...
                                                  <c:out value='${gpaTypeList.value[u.index]}' />
                                                  </option>
                </c:forEach>
                </select>
                <input type="hidden" id="unigpaPointCodeVal_${i.index+1}" name="unigpaPointCodeVal_${i.index+1}"
                ...
                <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                  <%-- 전공평점 표시 --%>
                    <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                      ...
                      <c:if test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\" MAJOR_GPA\"')}">
                        <tr>
                          <c:choose>
                            <c:when test="${jobNoticeInfo.careerTypeCode=='B'}">
                            ...
                            <c:otherwise>
                              <th scope="row"><label class="required" for="unimajorGpa_${i.index+1}"><span
                                    class="Lhide">(필수)</span>
                                  <LTag:message code="app.lbl.majorGpa" />
                                </label></th>
                            </c:otherwise>
                          ...
                          <td colspan="3">
                            <span class="set_selectInput">
                              <input type="text" id="unimajorGpa_${i.index+1}" name="unimajorGpa_${i.index+1}" size="3"
                                value="<c:out value='${uniInfo.majorGpa[i.index]}' />" maxlength="5"
                                onKeyPress="return $.onKeyPressFilter('[0-9.]', event);" style="ime-mode:disabled;"
                                onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
                              /
                              <select title="전공평점" id="unimajorGpaCode_${i.index+1}" name="unimajorGpaCode_${i.index+1}"
                                onChange="getText(this)">
                                <option value="">
                                  <LTag:message code="app.lbl.select" />
                                </option>
                                <c:forEach items="${gpaTypeList.code}" varStatus="o">
                                  <option value="<c:out value='${gpaTypeList.code[o.index]}' />" <c:if
                      ...
                      <input type="hidden" id="unimajorGpaCodeVal_${i.index+1}" name="unimajorGpaCodeVal_${i.index+1}"
                      ...
                      <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                        <%-- 전체이수학점 / 전공이수학점 표시 --%>
                          <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                            ...
                            <c:choose>
                              <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\" TOTAL_POINT\"') &&
                                ...
                                <%-- 전체이수학점, 전공이수학점 구분 모두 입력받음 --%>
                                  ...
                                  <tr>
                                    <c:choose>
                                      <c:when test="${jobNoticeInfo.careerTypeCode=='B'}">
                                        <th scope="row"><label for="unitotalPoint_${i.index+1}">
                                            <LTag:message code="app.lbl.totalPoint" />
                                          </label></th>
                                      </c:when>
                                      <c:otherwise>
                                        <th scope="row"><label class="required" for="unitotalPoint_${i.index+1}">
                                            <LTag:message code="app.lbl.totalPoint" />
                                          </label></th>
                                      </c:otherwise>
                                    </c:choose>
                                    <td>
                                      <input type="text" id="unitotalPoint_${i.index+1}"
                                        name="unitotalPoint_${i.index+1}" size="3"
                                        value="<c:out value='${uniInfo.totalPoint[i.index]}' />" maxlength="5"
                                        onKeyPress="return $.onKeyPressFilter('[0-9.]', event);"
                                        style="ime-mode:disabled;"
                                        onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
                                    </td>
                                    <c:choose>
                                      <c:when test="${jobNoticeInfo.careerTypeCode=='B'}">
                                        <th scope="row"><label for="unimajorPoint_${i.index+1}">
                                            <LTag:message code="app.lbl.majorPoint" />
                                          </label></th>
                                      </c:when>
                                      <c:otherwise>
                                        <th scope="row"><label class="required" for="unimajorPoint_${i.index+1}">
                                            <LTag:message code="app.lbl.majorPoint" />
                                          </label></th>
                                      </c:otherwise>
                                    </c:choose>
                                    <td>
                                      <input type="text" id="unimajorPoint_${i.index+1}"
                                        name="unimajorPoint_${i.index+1}" size="3"
                                        value="<c:out value='${uniInfo.majorPoint[i.index]}' />" maxlength="5"
                                        onKeyPress="return $.onKeyPressFilter('[0-9.]', event);"
                                        style="ime-mode:disabled;"
                                        onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
                                    </td>
                              ...
                              <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\" MAJOR_POINT\"')}">
                            ...
                            <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                              <%-- 복수전공이수학점 / 복수전공평점 표시 --%>
                                <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                                  ...
                                  <c:choose>
                                    <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\" DOUBLE_POINT\"')
                                      ...
                                      <%-- 복수전공이수학점, 복수전공평점 모두 입력받음 --%>
                                        ...
                                        <tr class="double" <c:if
                                          ...
                                          style="display:none;" </c:if>>
                                          <th scope="row"><label for="unidoublePoint_${i.index+1}">
                                              <LTag:message code="app.lbl.doublePoint" />
                                            </label></th>
                                          <td>
                                            <input type="text" id="unidoublePoint_${i.index+1}"
                                              name="unidoublePoint_${i.index+1}" size="3"
                                              value="<c:out value='${uniInfo.doublePoint[i.index]}' />" maxlength="5"
                                              onKeyPress="return $.onKeyPressFilter('[0-9.]', event);"
                                              style="ime-mode:disabled;"
                                              onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
                                          </td>
                                          <th scope="row"><label for="unidoubleMajorGpa_${i.index+1}">
                                              <LTag:message code="app.lbl.doubleMajorGpa" />
                                            </label></th>
                                          <td>
                                            <span class="set_selectInput">
                                              <input type="text" id="unidoubleMajorGpa_${i.index+1}"
                                                name="unidoubleMajorGpa_${i.index+1}" size="3"
                                                value="<c:out value='${uniInfo.doubleMajorGpa[i.index]}' />"
                                                maxlength="5" onKeyPress="return $.onKeyPressFilter('[0-9.]', event);"
                                                style="ime-mode:disabled;"
                                                onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
                                              /
                                              <select title="학점 총점" id="unidoubleMajorGpaCode_${i.index+1}"
                                                name="unidoubleMajorGpaCode_${i.index+1}" onChange="getText(this)">
                                                <option value="">
                                                  <LTag:message code="app.lbl.select" />
                                                </option>
                                                <c:forEach items="${gpaTypeList.code}" varStatus="u">
                                                  <option value="<c:out value='${gpaTypeList.code[u.index]}' />" <c:if
                                              ...
                                              <input type="hidden" id="unidoubleMajorGpaCodeVal_${i.index+1}"
                                    ...
                                    <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\" DOUBLE_GPA\"')}">
                                          ...
                                          <td colspan="3">
                                            <span class="set_selectInput">
                                              <input type="text" id="unidoubleMajorGpa_${i.index+1}"
                                                name="unidoubleMajorGpa_${i.index+1}" size="3"
                                                value="<c:out value='${uniInfo.doubleMajorGpa[i.index]}' />"
                                                maxlength="4" onKeyPress="return $.onKeyPressFilter('[0-9.]', event);"
                                                style="ime-mode:disabled;"
                                                onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
                                              /
                                              <select title="학점 총점" id="unidoubleMajorGpaCode_${i.index+1}"
                                          ...
                                          <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\"
                                            ...
                                            <%-- 부전공이수학점, 부전공평점 모두 입력받음 --%>
                                              ...
                                              <tr class="minor" <c:if
                                                ...
                                                <th scope="row"><label for="uniminorPoint_${i.index+1}">
                                                    <LTag:message code="app.lbl.minorPoint" />
                                                  </label></th>
                                                <td>
                                                  <input type="text" id="uniminorPoint_${i.index+1}"
                                                    name="uniminorPoint_${i.index+1}" size="3"
                                                ...
                                                <th scope="row"><label for="uniminorGpa_${i.index+1}">
                                                    <LTag:message code="app.lbl.minorGpa" />
                                                  </label></th>
                                                <td>
                                                  <span class="set_selectInput">
                                                    <input type="text" id="uniminorGpa_${i.index+1}"
                                                      name="uniminorGpa_${i.index+1}" size="3"
                                                      ...
                                                      onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
                                                    /
                                                    <select title="학점 총점" id="uniminorGpaCode_${i.index+1}"
                                                      name="uniminorGpaCode_${i.index+1}" onChange="getText(this)">
                                                      <option value="">
                                                        <LTag:message code="app.lbl.select" />
                                                      </option>
                                                      <c:forEach items="${gpaTypeList.code}" varStatus="o">
                                                        <option value="<c:out value='${gpaTypeList.code[o.index]}' />"
                                                          <c:if
                                                    ...
                                                    <input type="hidden" id="uniminorGpaPointVal_${i.index+1}"
                                        ...
                                        <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                                          <%-- 공학인증제 인증여부 입력 표시 --%>
                                            <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                                              ...
                                              <c:if test="${jobNoticeInfo.engineeringAccrFlag == 'N'}">
                                                <tr>
                                                  <th scope="row">
                                                    <label class="required"><span class="Lhide">(필수)</span>
                                                      <LTag:message code="app.lbl.engineeringFlag" />
                                                    </label>
                                                  </th>
                                                  <td colspan="3">
                                                    <input type="radio" id="uniengineeringAccrFlag_yes_${i.index+1}"
                                                      name="uniengineeringAccrFlag_${i.index+1}" value="Y" <c:if
                                                      test="${uniInfo.engineeringAccrFlag[i.index] == 'Y'}">
                                                    checked="checked"
                                              </c:if> ><label for="engineeringAccrFlag_yes">Yes</label>
                                              <input type="radio" id="uniengineeringAccrFlag_no_${i.index+1}"
                                                name="uniengineeringAccrFlag_${i.index+1}" value="N" <c:if
                                                test="${uniInfo.engineeringAccrFlag[i.index] == 'N'}">
                                              checked="checked" </c:if>
                                              ><label for="engineeringAccrFlag_no">No</label>
                                              </td>
                                              </tr>
                                              </c:if>
                                              </tbody>
            ...
            <div class="foldedInphone">
              <div class="dtFoldedInPhone btnmore">
                <div class="LblockPageSubtitle more">
                  ...
                  <div class="subtitleBtn">
                    <a href="#" class="btn_erase" onclick="fnEraseData('masterDiv');"><span class="Lhide">
              ...
              <div class="ddFoldedInPhone">
                <c:forEach items="${masterInfo.jobNoticeId}" varStatus="i">
                  <c:if test="${i.index != 0}">
                    <div class="btn_deleteTable"><button type="button" onClick="delDataInfo(this,'master');">다음 항목
                        삭제</button></div>
                  </c:if>
                  <div class="LblockDetailTable">
                    <%-- 비즈니스 로직에서 학교이름의 키를 파싱해서 숫자를 세므로 학교이름이 필수가 아닌 상황에서 로직을 맞춰주기위해 순번을 넣음. --%>
                      <input type="hidden" id="masterschoolSeqno_${i.index+1}" name="masterschoolSeqno_${i.index+1}"
                        value="${i.index+1}" />
                      <table class="applicationform rsp rsp-hori rsp-tablet">
                        <caption>
                          <LTag:message code="app.titl.master" />
                                ...
                                <c:choose>
                                  <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\" SCHOOL_NAME\"') &&
                                    ...
                                    <%-- 학교명, 소재지 모두 입력받음 --%>
                                      ...
                                      <tr>
                                        <th scope="row"><label class="required"
                                            for="masterschoolName_${i.index+1}"><span class="Lhide">(필수)</span>
                                            <LTag:message code="app.lbl.schoolName" />
                                          </label></th>
                                        <td>
                                          <div class="input_search">
                                            <input type="text" id="masterschoolName_${i.index+1}"
                                              name="masterschoolName_${i.index+1}"
                                              value="<c:out value='${masterInfo.schoolName[i.index]}' />" size="25"
                                              readonly="readonly" />
                                            <input type="hidden" id="masterschoolCode_${i.index+1}"
                                        ...
                                        <th scope="row"><label class="required"
                                            for="masterlocationName_${i.index+1}"><span class="Lhide">(필수)</span>
                                            <LTag:message code="app.lbl.locationName" />
                                          </label></th>
                                        <td>
                                          <div class="input_search">
                                            <input type="text" id="masterlocationName_${i.index+1}"
                                              name="masterlocationName_${i.index+1}"
                                              value="<c:out value='${masterInfo.locationName[i.index]}' />"
                                              readonly="readonly" maxlength="300" />
                                            <input type="hidden" id="masteraddressSido_${i.index+1}"
                                              name="masteraddressSido_${i.index+1}"
                                              value="<c:out value='${masterInfo.addressSido[i.index]}' />" />
                                            <input type="hidden" id="masteraddressSigu_${i.index+1}"
                                      ...
                                      <c:choose>
                                        <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\" PERIOD\"') &&
                                          ...
                                          <%-- 기간, 졸업구분 모두 입력받음 --%>
                                            ...
                                            <tr>
                                              <th scope="row"><label class="required"
                                                  for="masterstartDate_${i.index+1}"><span class="Lhide">(필수)</span>
                                                  <LTag:message code="app.lbl.preriodDate" />
                                                </label></th>
                                              <td>
                                                <input type="text" class="Ltext" id="masterstartDate_${i.index+1}"
                                                  name="masterstartDate_${i.index+1}" size="11"
                                                ...
                                                <label>~</label>
                                                <input type="text" class="Ltext" id="masterendDate_${i.index+1}"
                                                  name="masterendDate_${i.index+1}" size="11" maxlength="11"
                                                  value="<c:out value='${masterInfo.endDate[i.index]}' />"
                                                  readonly="readonly" title="기간 종료일" />
                                                <button type="button" class="LiconCalendar"
                                              ...
                                              <td>
                                                <select id="mastergraduationStatusCode_${i.index+1}"
                                          ...
                                          <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                                            ...
                                            <c:choose>
                                              <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\"
                                                ...
                                                <%-- 전공명, 전체평점 모두 입력받음 --%>
                                                  ...
                                                  <tr>
                                                    <th scope="row">
                                                      <label class="required" for="mastermajorName_${i.index+1}"><span
                                                          class="Lhide">(필수)</span>
                                                        <LTag:message code="app.lbl.majorName" />
                                                      </label>
                                                    </th>
                                                    ...
                                                    <th scope="row">
                                                      <label class="required" for="mastergpaPoint_${i.index+1}"><span
                                                          class="Lhide">(필수)</span>
                                                        <LTag:message code="app.lbl.gpaPoint" />
                                                      </label>
                                                    </th>
                                                    <td>
                                                      <span class="set_selectInput">
                                                        <input type="text" id="mastergpaPoint_${i.index+1}"
                                                          name="mastergpaPoint_${i.index+1}" size="3"
                                                          ...
                                                          onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
                                                        /
                                                        <select title="학점 총점" id="mastergpaPointCode_${i.index+1}"
                                                          name="mastergpaPointCode_${i.index+1}"
                                                          onChange="getText(this)">
                                                          <option value="">
                                                            <LTag:message code="app.lbl.select" />
                                                          </option>
                                                          <c:forEach items="${gpaTypeList.code}" varStatus="l">
                                                            <option
                                                              ...
                                                              >
                                                              <c:out value='${gpaTypeList.value[l.index]}' />
                                                            </option>
                                                          </c:forEach>
                                                        </select>
                                                        <input type="hidden" id="mastergpaPointCodeVal_${i.index+1}"
                                            ...
                                            <tr>
                                              <th scope="row"><label class="required"
                                                  for="masteracademicAdvisorName_${i.index+1}"><span
                                                    class="Lhide">(필수)</span>
                                                  <LTag:message code="app.lbl.msprofessor" />
                                                </label></th>
                                              <td>
                                                <input type="text" id="masteracademicAdvisorName_${i.index+1}"
                                                  name="masteracademicAdvisorName_${i.index+1}"
                                                  value="<c:out value='${masterInfo.academicAdvisorName[i.index]}' />"
                                                  maxlength="300" />
                                              </td>
                                              <th scope="row"><label class="required"
                                                  for=masterlabName_${i.index+1}><span class="Lhide">(필수)</span>
                                                  <LTag:message code="app.lbl.mastersUnivLab" />
                                                </label></th>
                                              <td>
                                                <input type="text" class="displayblock" style="min-width:97%;"
                                                  id="masterlabName_${i.index+1}" name="masterlabName_${i.index+1}"
                                            ...
                                            <tr>
                                              <th scope="row" rowspan="2">
                                                <label class="required" for="mastertitleOfStudy_${i.index+1}"><span
                                                    class="Lhide">(필수)</span>
                                                  <LTag:message code="app.lbl.msfield" />
                                                </label>
                                              </th>
                                              <td colspan="3">
                                                <span class="LsubInstruction">
                                                  <LTag:message code="app.cont.additionalTip13" />
                                                </span>
                                                <input type="text" class="displayblock"
                                                  id="mastertitleOfStudy_${i.index+1}"
                                                  name="mastertitleOfStudy_${i.index+1}" size=30
                                                  title="<LTag:message code=" app.lbl.msfield" />
                                                제목" value="
                                                <c:out value='${masterInfo.titleOfStudy[i.index]}' />
                                                " maxlength="300" />
                                              </td>
                                            </tr>
                                            <tr>
                                              <td colspan="3">
                                                <div class="td_sub">
                                                  <LTag:message code="app.lbl.charLength" />
                                                  <span id="masterChar_${i.index+1}">
                                                    0</span>/ 1500
                                                  <LTag:message code="app.lbl.char" />
                                                </div>
                                                <textarea title="자신의 주 연구 분야를 자유롭게 기술하세요. (어필할 수 있는 논문/특허/프로젝트 등 포함)"
                                                  id="mastercontent_${i.index+1}" name="mastercontent_${i.index+1}"
                                                  class="LtextArea"
                                                  placeholder="자신의 주 연구 분야를 자유롭게 기술하세요. (어필할 수 있는 논문/특허/프로젝트 등 포함)"><c:out value='${masterInfo.content[i.index]}' /></textarea>
                                              </td>
                                            </tr>
                                            <tr>
                                              <th scope="row"><label class="required"><span class="Lhide">(필수)</span>
                                                  <LTag:message code="app.lbl.mastersThesis" />
                                                </label></th>
                                              <td colspan="3" class="td_file">
                                                <div class="set_selectInput hiddenInPhone hiddenInTablet">
                                                  ...
                                                  <input type="hidden" id="masterattachFileId_${i.index+1}"
                                                  ...
                                                  <ul id="mastersThesis_${i.index+1}" class="LblockItemList Lfile">
                                                    <c:forEach items="${schoolFileList.attachFileId}" varStatus="j">
                                                      <c:if
                                                        ...
                                                        <li style="">
                                                          <p><a href="javascript:;"
                                                              ...
                                                              <c:out value='${schoolFileList.dlFileName[j.index]}' />
            ...
            <div class="foldedInphone">
              <div class="dtFoldedInPhone btnmore">
                <div class="LblockPageSubtitle more">
                  ...
                  <div class="subtitleBtn">
                    <a href="#" class="btn_erase" onclick="fnEraseData('doctorDiv');"><span class="Lhide">
              ...
              <div class="ddFoldedInPhone">
                <c:forEach items="${doctorInfo.jobNoticeId}" varStatus="i">
                  <c:if test="${i.index != 0}">
                    <div class="btn_deleteTable"><button type="button" onClick="delDataInfo(this,'doctor');">다음 항목
                        삭제</button></div>
                  </c:if>
                  <div class="LblockDetailTable">
                    <%-- 비즈니스 로직에서 학교이름의 키를 파싱해서 숫자를 세므로 학교이름이 필수가 아닌 상황에서 로직을 맞춰주기위해 순번을 넣음. --%>
                      <input type="hidden" id="doctorschoolSeqno_${i.index+1}" name="doctorschoolSeqno_${i.index+1}"
                        value="${i.index+1}" />
                      <table class="applicationform rsp rsp-hori rsp-tablet">
                        <caption>
                          <LTag:message code="app.titl.doctor" />
                                ...
                                <c:choose>
                                  <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\" SCHOOL_NAME\"') &&
                                    ...
                                    <%-- 학교명, 소재지 모두 입력받음 --%>
                                      ...
                                      <tr>
                                        <th scope="row"><label class="required"
                                            for="doctorschoolName_${i.index+1}"><span class="Lhide">(필수)</span>
                                            <LTag:message code="app.lbl.schoolName" />
                                          </label></th>
                                        <td>
                                          <div class="input_search">
                                            <input type="text" id="doctorschoolName_${i.index+1}"
                                              name="doctorschoolName_${i.index+1}"
                                              value="<c:out value='${doctorInfo.schoolName[i.index]}' />" size="25"
                                              readonly="readonly" />
                                            <input type="hidden" id="doctorschoolCode_${i.index+1}"
                                        ...
                                        <th scope="row"><label class="required"
                                            for="doctorlocationName_${i.index+1}"><span class="Lhide">(필수)</span>
                                            <LTag:message code="app.lbl.locationName" />
                                          </label></th>
                                        <td>
                                          <div class="input_search">
                                            <input type="text" id="doctorlocationName_${i.index+1}"
                                              name="doctorlocationName_${i.index+1}"
                                              value="<c:out value='${doctorInfo.locationName[i.index]}' />"
                                              readonly="readonly" maxlength="300" />
                                            <input type="hidden" id="doctoraddressSido_${i.index+1}"
                                              name="doctoraddressSido_${i.index+1}"
                                              value="<c:out value='${doctorInfo.addressSido[i.index]}' />" />
                                            <input type="hidden" id="doctoraddressSigu_${i.index+1}"
                                      ...
                                      <c:choose>
                                        <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\" PERIOD\"') &&
                                          ...
                                          <%-- 기간, 졸업구분 모두 입력받음 --%>
                                            ...
                                            <tr>
                                              <th scope="row"><label class="required"
                                                  for="doctorstartDate_${i.index+1}"><span class="Lhide">(필수)</span>
                                                  <LTag:message code="app.lbl.preriodDate" />
                                                </label></th>
                                              <td>
                                                <input type="text" class="Ltext" id="doctorstartDate_${i.index+1}"
                                                  name="doctorstartDate_${i.index+1}" size="11"
                                                ...
                                                <label>~</label>
                                                <input type="text" class="Ltext" id="doctorendDate_${i.index+1}"
                                                  name="doctorendDate_${i.index+1}" size="11" maxlength="11"
                                              ...
                                              <td>
                                                <select id="doctorgraduationStatusCode_${i.index+1}"
                                      ...
                                      <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                                        <%-- 전공명 / 전체평점 표시 --%>
                                          <%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                                            ...
                                            <c:choose>
                                              <c:when test="${fn:contains(jobNoticeInfo.schoolInputSelected, '\"
                                                ...
                                                <%-- 전공명, 전체평점 모두 입력받음 --%>
                                                  ...
                                                  <tr>
                                                    <th scope="row">
                                                      <label class="required" for="doctormajorName_${i.index+1}"><span
                                                          class="Lhide">(필수)</span>
                                                        <LTag:message code="app.lbl.majorName" />
                                                      </label>
                                                    </th>
                                                    <td>
                                                      <div class="input_search">
                                                        <input type="text" id="doctormajorName_${i.index+1}"
                                                          name="doctormajorName_${i.index+1}"
                                                          value="<c:out value='${doctorInfo.majorName[i.index]}' />"
                                                          size="25" readonly="readonly" />
                                                        <input type="hidden" id="doctormajorCode_${i.index+1}"
                                                    ...
                                                    <th scope="row">
                                                      <label class="required" for="doctorgpaPoint_${i.index+1}"><span
                                                          class="Lhide">(필수)</span>
                                                        <LTag:message code="app.lbl.gpaPoint" />
                                                      </label>
                                                    </th>
                                                    <td>
                                                      <span class="set_selectInput">
                                                        <input type="text" id="doctorgpaPoint_${i.index+1}"
                                                          name="doctorgpaPoint_${i.index+1}" size="3"
                                                          ...
                                                          onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
                                                        /
                                                        <select title="학점 총점" id="doctorgpaPointCode_${i.index+1}"
                                                        ...
                                                        <input type="hidden" id="doctorgpaPointCodeVal_${i.index+1}"
                                            ...
                                            <tr>
                                              <th scope="row"><label class="required"
                                                  for="doctormdDegreeCombined_${i.index+1}"><span
                                                    class="Lhide">(필수)</span>
                                                  <LTag:message code="app.lbl.masterDoctor" />
                                                </label></th>
                                              <td colspan="3">
                                                <input type="radio" id="doctormdDegreeCombined_yes_${i.index+1}"
                                                  name="doctormdDegreeCombined_${i.index+1}" value="Y" <c:if
                                                  test="${doctorInfo.mdDegreeCombined[i.index] == 'Y'}">
                                                checked="checked"
                                                </c:if> ><label
                                                  for="doctormdDegreeCombined_yes_${i.index+1}">Yes</label>
                                                <input type="radio" id="doctormdDegreeCombined_no_${i.index+1}"
                                                  name="doctormdDegreeCombined_${i.index+1}" value="N" <c:if
                                                  test="${doctorInfo.mdDegreeCombined[i.index] == 'N'}">
                                                checked="checked"
                                                </c:if> ><label for="doctormdDegreeCombined_no_${i.index+1}">No</label>
                                              </td>
                                            </tr>
                                            <tr>
                                              <th scope="row"><label class="required"
                                              ...
                                              <td>
                                                <input type="text" id="doctoracademicAdvisorName_${i.index+1}"
                                                  name="doctoracademicAdvisorName_${i.index+1}"
                                                  value="<c:out value='${doctorInfo.academicAdvisorName[i.index]}' />"
                                                  maxlength="300" />
                                              </td>
                                              <th scope="row"><label class="required"
                                                  for="doctorlabName_${i.index+1}"><span class="Lhide">(필수)</span>
                                                  <LTag:message code="app.lbl.mastersUnivLab" />
                                                </label></th>
                                              <td>
                                                <input type="text" class="displayblock" style="min-width:97%;"
                                                  id="doctorlabName_${i.index+1}" name="doctorlabName_${i.index+1}"
                                            ...
                                            <tr>
                                              <th scope="row" rowspan="2">
                                                <label class="required" for="doctortitleOfStudy_${i.index+1}"><span
                                                    class="Lhide">(필수)</span>
                                                  <LTag:message code="app.lbl.msfield" />
                                                </label>
                                              </th>
                                              <td colspan="3">
                                                ...
                                                <input type="text" class="displayblock"
                                                  ...
                                                  name="doctortitleOfStudy_${i.index+1}" title="<LTag:message code="
                                                  app.lbl.msfield" />
                                                제목" value="
                                                <c:out value='${doctorInfo.titleOfStudy[i.index]}' />
                                                " maxlength="300" />
                                              </td>
                                            </tr>
                                            <tr>
                                              <td colspan="3">
                                                <div class="td_sub">
                                                  <LTag:message code="app.lbl.charLength" />
                                                  <span id="doctorChar_${i.index+1}">
                                                    0</span>/ 1500
                                                  <LTag:message code="app.lbl.char" />
                                                </div>
                                                <textarea title="자신의 주 연구 분야를 자유롭게 기술하세요. (어필할 수 있는 논문/특허/프로젝트 등 포함)"
                                                  id="doctorcontent_${i.index+1}" name="doctorcontent_${i.index+1}"
                                                  class="LtextArea"
                                            ...
                                            <tr>
                                              ...
                                              <td colspan="3" class="td_file">
                                                <div class="set_selectInput hiddenInPhone hiddenInTablet">
                                                  <input type="hidden" id="doctorattachFileId_${i.index+1}"
                                                  ...
                                                  <ul id="doctorThesis_${i.index+1}" class="LblockItemList Lfile">
                                                    <c:forEach items="${schoolFileList.attachFileId}" varStatus="j">
                                                      <c:if
                ...
                <div class="LblockDetailTable">
                  <table class="applicationform rsp rsp-hori rsp-tablet">
                    ...
                    <tbody>
                      <c:if test="${jobNoticeInfo.reputeAgreeYn == 'N'}">
                        <tr>
                          <th scope="row"><label class="required" for="reputeAgreeYn"><span class="Lhide">(필수)</span>
                              <LTag:message code="app.lbl.repute.agree" />
                            </label></th>
                          <td>
                            <div style="float:left">
                              <input type="radio" id="reputeAgreeYn_yes" name="reputeAgreeYn" value="Y" <c:if
                                test="${baseInfo.reputeAgreeYn=='Y'}"> checked="checked"
                      </c:if> disabled="disabled" /><label for="reputeAgreeYn_yes">동의함</label>
                      <input type="radio" id="reputeAgreeYn_no" name="reputeAgreeYn" value="N" <c:if
                        test="${baseInfo.reputeAgreeYn=='N'}"> checked="checked"
          ...
          <%-- <br>
            ...
            <c:if test="${jobNoticeInfo.saleSecViolAgreeYn == 'N'}">
              <tr>
                <th scope="row"><label class="required" for="saleSecViolAgreeYn"><span class="Lhide">(필수)</span>
                    <LTag:message code="app.lbl.salesecviol.agree" />
                  </label></th>
                <td>
                  <div style="float:left">
                    <input type="radio" id="saleSecViolAgreeYn_yes" name="saleSecViolAgreeYn" value="Y" <c:if
                      test="${baseInfo.saleAgreeYn=='Y'}"> checked="checked"
            ...
            <input type="hidden" id="saleSecViolAgreeYn" name="saleSecViolAgreeYn" value="${baseInfo.saleAgreeYn}" />
            ...
            <c:if test="${jobNoticeInfo.languageInputFlag == 'N'}">
              <div class="foldedInphone">
                <div class="dtFoldedInPhone btnmore">
                  <div class="LblockPageSubtitle">
                    <h3>
                      <LTag:message code="app.lbl.languageGrade" /> <span id="languageCount">(1)</span>
                    </h3>
                    <div class="subtitleBtn">
                ...
                <div class="ddFoldedInPhone">
                  <div class="LblockListTable headerTop">
                    <table id="languageTable" class="applyformHeaderTop rsp rsp-basic">
                      ...
                      <thead>
                        <tr>
                          <th scope="col"><label class="required" for="offilanguageCode_1"><span class="Lhide"></span>
                              <LTag:message code="app.lbl.language" />
                            </label></th>
                          <th scope="col"><label class="required" for="offilangTestCode_1"><span class="Lhide"></span>
                              <LTag:message code="app.lbl.testName" />
                            </label></th>
                          <th scope="col"><label class="required" for="offipointGradeValue_1"><span
                                class="Lhide"></span>
                              <c:choose>
                          ...
                          <th scope="col"><label class="required" for="offitestDate_1"><span class="Lhide"></span>
                        ...
                        <tr>
                          <td>
                            <select id="offilanguageCode_1" name="offilanguageCode_1"
                              onChange="getlangTestList(this,'')" title="<LTag:message code=" app.lbl.language" />">
                            <option value="">
                              <LTag:message code="app.lbl.select" />
                            </option>
                            <c:forEach items="${languageTypeList.code}" varStatus="l">
                              <option value="<c:out value='${languageTypeList.code[l.index]}' />">
                          ...
                          <td>
                            <select id="offilangTestCode_1" name="offilangTestCode_1"
                              onChange="getGradeValueList(this,'')" title="<LTag:message code=" app.lbl.testName" />">
                            <option value="">
                              <LTag:message code="app.lbl.select" />
                            </option>
                            </select>
                          ...
                          <td>
                            <div id="divoffipointGradeValue_1">
                              <c:choose>
                                <c:when test="${jobNoticeInfo.passOption == 'Y'}">
                                  <select id="offipointGradeValue_1" name="offipointGradeValue_1"
                                    title="<LTag:message code=" app.lbl.passOptionFlag" />">
                                  <option value="">
                                    <LTag:message code="app.lbl.select" />
                                  </option>
            ...
            <td>
              <input type="text" class="Ltext dateText" id="offitestDate_1" name="offitestDate_1" size="11"
                maxlength="11" readonly="readonly" title="<LTag:message code=" app.lbl.acquiredDate" />">
              <button type="button" class="LiconCalendar" id="offiCal" data-calendar="offitestDate_1">달력</button>
            </td>
            <td>
                ...
                <div class="ddFoldedInPhone">
                  <div class="LblockListTable headerTop">
                    <table id="globalTable" class="applyformHeaderTop rsp rsp-basic">
                      ...
                      <thead>
                        <tr>
                          <th scope="col"><label class="required" for="glolanguageType_1"><span class="Lhide"></span>
                              <LTag:message code="app.lbl.language" />
                            </label></th>
                          <th scope="col"><label class="required" for="glouseCountryCode_1"><span class="Lhide"></span>
                              <LTag:message code="app.lbl.languageNation" />
                            </label></th>
                          <th scope="col"><label class="required" for="glouseStartDate_1"><span class="Lhide"></span>
                              <LTag:message code="app.lbl.languageLevel" /><a href="javascript:;"
                                onclick="languageGuidePopup();" target="_blank" title="새 창"> <span class="image"
                                  data-src="btn_icon_question.png" data-alt="외국어 역량 가이드 팝업"></span></a>
                            </label></th>
                          <th scope="col"></th>
                        </tr>
                      </thead>
                      <tbody>
                        <c:forEach items="${globalCompetList.jobNoticeId}" varStatus="i">
                          <tr>
                            <td>
                              <select class="glolanguageType" id="glolanguageType_${i.index+1}"
                                name="glolanguageType_${i.index+1}" title="<LTag:message code=" app.lbl.language" />">
                              <option value="">
                                <LTag:message code="app.lbl.select" />
                              </option>
                              <c:forEach items="${languageTypeList2.code}" varStatus="l">
                                <option value="<c:out value='${languageTypeList2.code[l.index]}' />" <c:if
            ...
            <td>
              <div class="input_search">
                <input type="text" class="glouseCountryName" id="glouseCountryName_${i.index+1}"
                  ...
                  value="<c:out value='${globalCompetList.useCountryName[i.index]}' />" readonly="readonly"
                  title="<LTag:message code=" app.lbl.languageNation" />" <c:if
            ...
            <td>
              <select class="glolanguageLevel" id="glolanguageLevel_${i.index+1}" name="glolanguageLevel_${i.index+1}"
                title="<LTag:message code=" app.lbl.languageLevel" />">
              <option value="">
                <LTag:message code="app.lbl.select" />
              </option>
            ...
            <td>
              <a href="javascript:;" id="globalDelBtn_${i.index+1}" onClick="deleteRow(this);"><span class="image"
                  data-src="ico_deleteAboveRow.png" data-alt="행 삭제"></span></a>
            </td>
            </tr>
            </c:forEach>
                ...
                <div class="ddFoldedInPhone">
                  <div class="LblockListTable headerTop">
                    <table id="qualifTable" class="applyformHeaderTop rsp rsp-basic">
                      ...
                      <thead>
                        <tr>
                          <th scope="col"><label class="required" for="certiqualificationName_1"><span
                                class="Lhide"></span>
                              <LTag:message code="app.lbl.qualificationName" />
                            </label></th>
                          <th scope="col"><label class="required" for="certiqualGradeName_1"><span class="Lhide"></span>
                              <LTag:message code="app.lbl.qualGrade" />
                            </label></th>
                          <th scope="col"><label class="required" for="certiacquisitionDate_1"><span
                                class="Lhide"></span>
                              <LTag:message code="app.lbl.acquiredDate" />
                            </label></th>
                          <th scope="col"><label class="required" for="certicertInstitutionName_1"><span
                                class="Lhide"></span>
                      ...
                      <tbody>
                        <c:forEach items="${qualificationList.jobNoticeId}" varStatus="i">
                          <tr>
                            <td>
                              <div class="input_search">
                                <input type="text" id="certiqualificationName_${i.index+1}"
                                  name="certiqualificationName_${i.index+1}"
                                  value="<c:out value='${qualificationList.qualificationName[i.index]}' />" size="10"
                                  readonly="readonly" title="<LTag:message code=" app.lbl.qualificationName" />" />
                                <input type="hidden" id="certiqualificationCode_${i.index+1}"
                                  name="certiqualificationCode_${i.index+1}"
                                  value="<c:out value='${qualificationList.qualificationCode[i.index]}'/>" />
                                <button type="button" onclick="searchCodePopup(this,'CR');">검색</button>
                              </div>
                            </td>
                            <td>
                              <input type="text" class="Ltext" id="certiqualGradeName_${i.index+1}"
                                name="certiqualGradeName_${i.index+1}"
                                value="<c:out value='${qualificationList.qualGradeName[i.index]}' />" size="10"
                                maxlength="100" title="<LTag:message code=" app.lbl.qualGrade" />" >
                            </td>
                            <td>
                              <input type="text" class="Ltext calendarDate" id="certiacquisitionDate_${i.index+1}"
                                name="certiacquisitionDate_${i.index+1}"
                                value="<c:out value='${qualificationList.acquisitionDate[i.index]}' />" size="11"
                                maxlength="11" readonly="readonly" title="<LTag:message code=" app.lbl.acquiredDate" />"
                              >
                              <button type="button" class="LiconCalendar" id="cal" data-position="up"
                                data-calendar="certiacquisitionDate_${i.index+1}">달력</button>
                            </td>
                            <td>
                              <input type="text" class="Ltext" id="certicertInstitutionName_${i.index+1}"
                                name="certicertInstitutionName_${i.index+1}"
                                value="<c:out value='${qualificationList.certInstitutionName[i.index]}' />" size="10"
                                maxlength="100" title="<LTag:message code=" app.lbl.certInstitution" />" >
                            </td>
                            <td>
                              <a href="javascript:;" id="qualDelBtn_${i.index+1}" onClick="deleteRow(this);"><span
                        ...
                        <tbody>
                          <tr>
                            <td style="text-align: left;">
                              <input type="hidden" name="customFieldId" value="${addTextList.customFieldId[i.index]}" />
                              <input type="hidden" name="categoryName" value="${addTextList.categoryName[i.index]}" />
                              <input type="hidden" name="title" value="${addTextList.title[i.index]}" />
                              <c:choose>
                                <c:when test="${addTextList.type[i.index] eq 'TEXT'}">
                                  <input type="hidden" name="addTextValue" value="${addTextList.value[i.index]}" />
                                  <c:forEach begin="0" end="${jobNoticeInfo.addTextInputNum-1}" step="1" varStatus="k">
                                    <input type="text" name="addTextValue_${k.index}" class="addTextValue"
                                      value="${fn:split(addTextList.value[i.index],'§')[k.index]}" />
                                  </c:forEach>
                                </c:when>

                                <c:when test="${addTextList.type[i.index] eq 'TEXTAREA'}">
                                  <textarea
                                    name="addTextValue"><c:out value="${addTextList.value[i.index]}"/></textarea>
                                </c:when>
                                <c:when test="${addTextList.type[i.index] eq 'CHECKBOX'}">
                                  <input type="hidden" name="addTextValue" value="${addTextList.value[i.index]}" />
                                  <c:forTokens items="${addTextList.labels[i.index]}" delims="§" var="tag">
                                    <c:set var="addTextChecboxChecked" value="false" />
                                    <c:forTokens items="${addTextList.value[i.index]}" delims="§" var="valueToken">
                                      <c:if test="${tag eq valueToken}">
                                        <c:set var="addTextChecboxChecked" value="true" />
                                      </c:if>
                                    </c:forTokens>
                                    <c:choose>
                                      <c:when test="${addTextChecboxChecked eq 'true'}">
                                        <input type="checkbox" class="addTextValue" value="${tag}" checked="checked" />
                                        <c:out value="${tag}" />
                                      </c:when>
                                      <c:otherwise>
                                        <input type="checkbox" class="addTextValue" value="${tag}" />
                                        <c:out value="${tag}" />
                                      </c:otherwise>
                                    </c:choose>
                                  </c:forTokens>
                                  ...
                                  <c:forTokens items="${addTextList.labels[i.index]}" delims="§" var="tag">
                                    <c:choose>
                                      <c:when test="${tag eq addTextList.value[i.index]}">
                                        <input type="radio" name="addTextValue" value="${tag}" checked="checked" />
                                        <c:out value="${tag}" />
                                      </c:when>
                                      <c:otherwise>
                                        <input type="radio" name="addTextValue" value="${tag}" />
                                        <c:out value="${tag}" />
                                      </c:otherwise>
                                    </c:choose>
                                  </c:forTokens>
                    ...
                    <div class="ddFoldedInPhone">
                      <div id="LblockCareers">
                        <c:forEach items="${prevExperList.jobNoticeId}" varStatus="k">
                          <c:if test="${k.index != 0}">
                            <div class="btn_deleteTable"><button type="button" onClick="delDataInfo(this);">다음 항목
                                삭제</button></div>
                          </c:if>
                              ...
                              <tbody>
                                <tr>
                                  <th scope="row">
                                    ...
                                    <label class="required" for="companyName_${k.index+1}"><span
                                        class="Lhide">(필수)</span>
                                  ...
                                  <th scope="row"><label class="required" for="startDate_${k.index+1}"><span
                                        class="Lhide">(필수)</span>
                                      <LTag:message code="app.lbl.preriodDate" />
                                    </label></th>
                                  <td>
                                    <input type="text" class="Ltext" id="startDate_${k.index+1}"
                                      name="startDate_${k.index+1}" size="11" maxlength="7" placeholder="YYYY.MM"
                                      ...
                                      onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
                                    <label>~</label>
                                    <input type="text" class="Ltext" id="endDate_${k.index+1}" size="11"
                                ...
                                <tr>
                                  <th scope="row"><label class="required" for="careerLocationName_${k.index+1}"><span
                                        class="Lhide">(필수)</span>
                                      <LTag:message code="app.lbl.locationName" />
                                    </label></th>
                                  <td>
                                    <div class="input_search">
                                      <input type="text" id="careerLocationName_${k.index+1}"
                                        name="locationName_${k.index+1}" size="10"
                                        value="<c:out value='${prevExperList.locationName[k.index]}' />"
                                        readonly="readonly" maxlength="300" />
                                      <input type="hidden" id="careerAddressSido_${k.index+1}"
                                  ...
                                  <th scope="row"><label class="required" for="orgName_${k.index+1}"><span
                                        class="Lhide">(필수)</span>
                                ...
                                <tr>
                                  ...
                                  <th scope="row"><label class="required" for="careerJobCode_${k.index+1}"><span
                                        class="Lhide">(필수)</span>
                                      <LTag:message code="app.lbl.jobCode" />
                                    </label></th>
                                  <td>
                                ...
                                <tr>
                                  <th scope="row"><label class="required" for="exitReasonCode_${k.index+1}"><span
                                        class="Lhide">(필수)</span>
              ...
              <thead>
                <tr>
                  <th scope="col" class="LtextLeft">
                    <label class="required" for="expContent_${i.index+1}"><span class="Lhide">(필수)</span>
            ...
            <c:if test="${jobNoticeInfo.careerTypeCode == 'B' || jobNoticeInfo.careerTypeCode == 'D'}">
              ...
              <div class="LblockDetailTable">
                <table class="applicationdetails rsp rsp-hori rsp-tablet">
                  ...
                  <tbody>
                    <tr>
                      <th scope="row"><label class="required" for="targetSalary"><span class="Lhide">(필수)</span>
                          <LTag:message code="app.lbl.targetSalary" />
                        </label></th>
                      <td>
                        <input id="targetSalary" name="targetSalary" type="text"
                          value="<c:out value='${baseInfo.targetSalary}'/>" size="15" maxlength="15"
                          onKeyPress="return $.onKeyPressFilter('[0-9]', event);" style="ime-mode:disabled;"
                          onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" />
                      </td>
                      <th scope="row"><label class="required" for="entryDate"><span class="Lhide">(필수)</span>
...
=======================================================================================================
            ...
            <div id="LblockTabContent04" class="LblockTabContent">
                          ...
                          <tr>
                            <th scope="col" class="LtextLeft">
                              <label for="content_${i.index+1}">
                                <c:out value='${appIntroduceInfo.questionText[i.index]}' />
                                <a href="javascript:;" onClick="writeGuidePopup();" target="_blank" title="새 창"><span
                                    class="image" data-src="btn_icon_question.png" data-alt="자기소개서 작성 가이드"></span></a>
              ...
              <div class="LblockTabButton">
                ...
                <button type="button" onclick="nextTab(this,<c:choose><c:when test=" ${jobNoticeInfo.careerTypeCode=='A'
